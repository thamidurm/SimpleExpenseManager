...
import lk.ac.mrt.cse.dbs.simpleexpensemanager.data.helper.ExpenseManagerDbHelper;
...
public class PersistentDemoExpenseManager extends ExpenseManager {
    ...
    public void setup() {
        ...
        ExpenseManagerDbHelper dbHelper = new ExpenseManagerDbHelper(this.context);
